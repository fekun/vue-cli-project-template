...
export const asyncRoutes = [
  ...
  /** when your routing map is too long, you can split it into small modules **/
  {
    path: '/nest',
    component: Layout,
    meta: { title: 'nested', icon: 'tree-table' },
    children: [
      {
        path: 'menu1',
      ...
      },
      {
        path: 'admin',
        name: 'NestAdmin',
        component: () => import('@/views/nest/admin'),
        meta: { title: 'nest-admin', roles: ['admin'] }// 这里不设置roles代表该路任何人可访问
      },
      {
        path: 'anynone',
        name: 'NestAnyone',
        component: () => import('@/views/nest/anyone'),
        meta: { title: 'nest-anyone' }
      }
    ]
  },
